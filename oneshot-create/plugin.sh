...
JS_FILE="oneshot-create.js"
JS_DEST="/usr/share/pve-manager/js/$JS_FILE"
SCRIPT_MARKER="<!-- PVE_ONESHOT_CREATE_SCRIPT -->"
PM_PLUGIN_NAME="oneshot-create"
...
marker = '<!-- PVE_ONESHOT_CREATE_SCRIPT -->'
script = marker + '\n    <script src="/pve2/js/oneshot-create.js"></script>'

text = text.replace('    <script src="/pve2/js/oneshot-create.js"></script>\n', '')
text = text.replace('    <script src="/pve2/js/oneshot-create.js"></script>', '')
...
template = Path('/usr/share/pve-manager/index.html.tpl')
text = template.read_text()
text = text.replace('<!-- PVE_ONESHOT_CREATE_SCRIPT -->\n    <script src="/pve2/js/oneshot-create.js"></script>\n', '')
text = text.replace('<!-- PVE_ONESHOT_CREATE_SCRIPT -->\n    <script src="/pve2/js/oneshot-create.js"></script>', '')
text = text.replace('    <script src="/pve2/js/oneshot-create.js"></script>\n', '')
text = text.replace('    <script src="/pve2/js/oneshot-create.js"></script>', '')
template.write_text(text)
